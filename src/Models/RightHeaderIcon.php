...
class RightHeaderIcon extends Model
{
     ...
     * @var string
     */
    protected $table = 'mightyweb_right_header_icons';
    ...
    public function getImageUrlAttribute(): ?string
    {
        ...
        return Storage::disk($disk)->url($path . '/righticon/' . $this->image);
    }
    ...
    public function deleteImage(): bool
    {
        ...
        $disk = config('mightyweb.storage.disk', 'public');
        $path = config('mightyweb.storage.path', 'mightyweb');
        $fullPath = $path . '/righticon/' . $this->image;
    ...
    {
        static::deleting(function (RightHeaderIcon $icon) {
            $icon->deleteImage();
        });
    }
}
