...
use MightyWeb\MightyWeb\Models\Tab;
...
<div class="p-6">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h2 size="xl">Bottom Tabs</h2>
            <p size="sm" class="text-gray-600 dark:text-gray-400">Manage your app's bottom navigation tabs</p>
        </div>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse ($tabs as $tab)
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <button wire:click="toggleActive({{ $tab->id }})" 
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium transition {{ $tab->is_active ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400 hover:bg-green-200 dark:hover:bg-green-900/50' : 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600' }}">
                                    {{ $tab->is_active ? 'Active' : 'Inactive' }}
                                </button>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    <button wire:click="openEditModal({{ $tab->id }})" 
                                            class="text-primary-600 hover:text-primary-900 dark:text-primary-400 dark:hover:text-primary-300">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                        </svg>
                                    </button>
                                    <button wire:click="confirmDelete({{ $tab->id }})" 
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No tabs found</h3>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating a new bottom tab.</p>
                                <div class="mt-6">
                                    <x-button variant="primary" wire:click="openCreateModal">
                                        <x-slot:iconLeft>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
    ...
    <x-confirmation-modal wire:model="confirmingDelete">
        <x-slot:title>Delete Tab</x-slot:title>
        <x-slot:content>
    ...
    <x-modal wire:model="showCreateModal" max-width="2xl">
        <x-slot:title>Create New Tab</x-slot:title>
        <x-slot:content>
            <form wire:submit.prevent="save" class="space-y-6">
                ...
                <x-form.input 
                    ...
                    help="The URL or deep link for this tab" />
        ...
        <x-slot:footer>
            <x-button variant="secondary" @click="show = false">Cancel</x-button>
            <x-button variant="primary" wire:click="save" :loading="true">Create Tab</x-button>
        </x-slot:footer>
    </x-modal>

    <!-- Edit Tab Modal -->
    <x-modal wire:model="showEditModal" max-width="2xl">
        <x-slot:title>Edit Tab</x-slot:title>
        <x-slot:content>
        ...
        <x-slot:footer>
            <x-button variant="secondary" @click="show = false">Cancel</x-button>
            <x-button variant="primary" wire:click="update" :loading="true">Update Tab</x-button>
        </x-slot:footer>
    </x-modal>
